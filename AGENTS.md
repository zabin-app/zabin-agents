...
- Keep one contract per role or workflow. [`skills/conductor`](skills/conductor/README.md) is the single conductor; host-specific translation belongs in an adapter note beside the skill it serves, never in a forked copy, and retired contracts stay uninstalled under [`attic/`](attic/).
